...
def normalize_team(dataset):
	...
	dataset = numpy.delete(dataset, [2, 3, 4, 5, 10], axis = 1)
	dataset = dataset[::2]
...
def plotAccuracy(NN_Percents, Consensus_Percents):
	year = ['Week 1', 'Week 2', 'Week 3', 'Week 4', 'Week 5', 'Week 6', 'Week 7', 'Week 8', 'Week 9', 'Week 10', 'Week 11', 'Week 12', 'Week 13', 'Week 14']
	N = len(NN_Percents)
	ind = numpy.arange(N)
	width = 0.35
	...
	ax.set_title('Prediction Accuracy For 2016 week 1 ~ 14')
...
dataset[:, [ 2, 3, 4, 5, 6, 7, 74]] = scaler.fit_transform(dataset[:, [ 2, 3, 4, 5, 6, 7, 74]])
