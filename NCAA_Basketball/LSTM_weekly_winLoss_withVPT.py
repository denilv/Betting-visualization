...
def mapping(name):
	...
	teams = ['MSU', 'CONN', 'GAST', 'DUKE', 'LT', 'TXAM', 'MD', 'UK', 'INST', 'UCLA', 'TNST', 'BYU', 'BUCK', 'PUR', 'BRY', 'IND', 'OSU', 'MARQ', 'GTWN', 'FLA', 'MRSH', 'VILL', 'HOF', 'PUR', 'FAU', 'UNC', 'DUQ', 'MILW', 'SCAR', 'NMSU', 'ORST', 'SYR', 'SDSU', 'COLG', 'BUFF', 'FSU', 'YSU', 'UGA', 'CMU', 'IOWA', 'TROY', 'TXAM', 'WVU', 'GONZ', '']
...
def plotAccuracy(NN_Percents, Consensus_Percents):
	...
	plt.savefig('results/accuracy_chart_winLoss.png', bbox_inches = 'tight', dpi = 100)
...
# save Model
filename = 'saveModels/ModelWeeklyWithVPT_winLoss.h5'
model.save(filename)
